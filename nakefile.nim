...
task "windows-x64-build", "Build nifty for Windows (x64)":
  direshell compile, windows_x64, hs_file

task "linux-x86-build", "Build nifty for Linux (x86)":
  direshell compile, linux_x86,  hs_file
  
task "linux-x64-build", "Build nifty for Linux (x64)":
  direshell compile, linux_x64,  hs_file
  
task "linux-arm-build", "Build nifty for Linux (ARM)":
  direshell compile, linux_arm,  hs_file
  
task "macosx-x64-build", "Build nifty for Mac OS X (x64)":
